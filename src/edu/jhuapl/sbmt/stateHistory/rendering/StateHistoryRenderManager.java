...
//import edu.jhuapl.sbmt.stateHistory.model.stateHistory.StateHistoryCollectionChangedListener;
...
//			setupTimeBar();
//
//		System.out.println("StateHistoryRenderManager: initialize: adding change listener");
//		historyModel.getRuns().addRenderChangedListener(new StateHistoryCollectionChangedListener()
//		{
//
//        	@Override
...
//			{
//        		System.out.println(
//						"StateHistoryRenderManager.initialize().new StateHistoryCollectionChangedListener() {...}: historySegmentMapped: mapping");
