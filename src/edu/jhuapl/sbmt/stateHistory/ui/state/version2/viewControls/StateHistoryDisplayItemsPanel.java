...
//	StateHistoryDisplayItemShowSpacecraftPointerPanel showSpacecraftPointerPanel;
	// StateHistoryDisplayInstrumentFootprintBorderPanel
	// showInstrumentFootprintBorderPanel;
...
//		add(showSpacecraftPointerPanel = new StateHistoryDisplayItemShowSpacecraftPointerPanel());
		...
		// add(Box.createVerticalGlue());
		// add(showInstrumentFrustumPanel = new
		// StateHistoryDisplayInstrumentFrustumPanel());
		// add(Box.createVerticalGlue());
		// add(showInstrumentFootprintPanel = new
		// StateHistoryDisplayInstrumentFootprintPanel());
		// add(Box.createVerticalGlue());
		// add(showInstrumentFootprintBorderPanel = new
		// StateHistoryDisplayInstrumentFootprintBorderPanel());
